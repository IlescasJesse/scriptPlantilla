...
const asignacionesPath = path.join(__dirname, "COMISIONES/ASIGNACIONES_LABORALES.xlsx");
const comisionadosPath = path.join(__dirname, "COMISIONES/COMISIONADOS_SINDICALES.xlsx");
            ...
            update: {
              $set: {
                STATUS_EMPLEADO: {
                  ...
                  DESDE: null,
                  HASTA: null,
                  LUGAR_COMISIONADO: asignacion.ADSCRIPCION || null,
                  OBSERVACIONES: null,
                  PRYECTO: null,
                },
              },
